...
class ScalewayAdapter(BaseAdapter):
    def __init__(self, role: str = "default"):
        super().__init__("SCALEWAY_API_KEY", "https://api.scaleway.ai/v1alpha1/chat/completions", role=role)
    ...
    def _call_api(self, messages, **kwargs):
        ...
        payload = {
            "model": kwargs.get("model", "scaleway/llama-3.1-8b-instruct"),
            "messages": messages,
    ...
    def _estimate_cost(self, tokens):
        return tokens * 0.000001  # Scaleway pricing approximation